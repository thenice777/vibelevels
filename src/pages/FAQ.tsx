  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-3xl font-bold text-white mb-4">Vibe Coding Troubleshooting: Solutions to Common AI Coding Problems</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {faqCategories.map((category, index) => (
            <Link to={`/faq/${category.slug}`} key={index}>
              <Card className="h-full hover:border-primary/50 transition-all duration-200 border-white/10">
